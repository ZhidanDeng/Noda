...
//add
func (api *EthereumAPI) RegisterPlg(plgName string) string {
	
	path := "/home/dan/plugin/" + plgName + ".so"
...
func (api *EthereumAPI) UnregisterPlg(plgName string) string {
	dan.UnPlg = plgName
	dan.IsUn = true
	return "UnRegister Start"
}
